namespace LPAP.Forms.Views
{
    partial class AudioCollectionView
    {
		...
		private void InitializeComponent()
		{
			...
			this.timeStretchInfoToolStripMenuItem = new ToolStripMenuItem();
			this.deleteToolStripMenuItem = new ToolStripMenuItem();
			this.metricsInfoToolStripMenuItem = new ToolStripMenuItem();
			...
			// 
			this.contextMenuStrip_listBox.Items.AddRange(new ToolStripItem[] { this.openAsTrackToolStripMenuItem, this.renameToolStripMenuItem, this.editTagsToolStripMenuItem, this.visualizerToolStripMenuItem, this.stemsToolStripMenuItem, this.addNumberingToolStripMenuItem, this.resampleToolStripMenuItem, this.rechannelToolStripMenuItem, this.timeStretchToolStripMenuItem, this.infoToolStripMenuItem, this.deleteToolStripMenuItem });
			this.contextMenuStrip_listBox.Name = "contextMenuStrip_listBox";
			this.contextMenuStrip_listBox.Size = new Size(181, 268);
			// 
			...
			// 
			this.infoToolStripMenuItem.DropDownItems.AddRange(new ToolStripItem[] { this.metricsInfoToolStripMenuItem, this.timeStretchInfoToolStripMenuItem });
			this.infoToolStripMenuItem.Name = "infoToolStripMenuItem";
			this.infoToolStripMenuItem.Size = new Size(180, 22);
			this.infoToolStripMenuItem.Text = "Info";
			// 
			// timeStretchInfoToolStripMenuItem
			// 
			this.timeStretchInfoToolStripMenuItem.Name = "timeStretchInfoToolStripMenuItem";
			this.timeStretchInfoToolStripMenuItem.Size = new Size(180, 22);
			this.timeStretchInfoToolStripMenuItem.Text = "Time-Stretch Info";
			this.timeStretchInfoToolStripMenuItem.Click += this.timeStretchInfoToolStripMenuItem_Click;
			// 
			...
			// 
			// metricsInfoToolStripMenuItem
			// 
			this.metricsInfoToolStripMenuItem.Name = "metricsInfoToolStripMenuItem";
			this.metricsInfoToolStripMenuItem.Size = new Size(180, 22);
			this.metricsInfoToolStripMenuItem.Text = "Metrics Info";
			this.metricsInfoToolStripMenuItem.Click += this.metricsInfoToolStripMenuItem_Click;
			// 
			// AudioCollectionView
			// 
        ...
        private ToolStripMenuItem timeStretchInfoToolStripMenuItem;
		private ToolStripMenuItem metricsInfoToolStripMenuItem;
	}
}