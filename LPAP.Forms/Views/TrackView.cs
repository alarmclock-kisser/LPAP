...
namespace LPAP.Forms.Views
{
	public partial class TrackView : Form
	{
		...
		private async void WaveTimer_Tick(object? sender, EventArgs e)
		{
			...
			this.label_volume.Text = $"Vol {(int) (this.Volume * 100)}%";
		...
		protected override bool ProcessCmdKey(ref Message msg, Keys keyData)
		{
			...
			{
				this.copyToolStripMenuItem_Click(this, EventArgs.Empty);
				this.removeToolStripMenuItem_Click(this, EventArgs.Empty);
				return true;
			}
			...
			{
				// New empty track
				var newAudio = AudioCollection.CreateNewEmpty();
				var tv = new TrackView(newAudio, this.SourceAudioCollection);
			}
		...
		private void applyToolStripMenuItem_Click(object sender, EventArgs e)
		{
			...
			{
				_ = new TrackView(this.Audio.Clone(keepId: true));
			}
			else
			{
				// overwrite existing item by Id in the source collection
